...
void Initialize::mappingPort()
{
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(551, 1));		// AHM
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(552, 2));		// SRT
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(553, 3));		// BRD
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(554, 4));		// RJK
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(555, 5));		// NVS
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(556, 6));		// MHN
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(557, 7));		// ANK
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(558, 8));		// BLM
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(559, 9));		// BRDL
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(560, 10));		// KIM
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(561, 11));		// BRC
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(562, 12));		// JAM
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(563, 13));		// MOR
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(564, 14));		// HLL
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(565, 15));		// NAD
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(566, 16));		// PAT
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(567, 17));		// VAR
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(568, 18));		// AND
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(569, 19));		// JAI
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(570, 20));		// BHAV
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(571, 21));		// JNG
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(572, 22));		// AHM BNG
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(573, 23));		// HYD 2E
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(575, 24));		// PUNE
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(576, 25));		// VAPI
	initSection::ipMappingMap.insert(std::pair<uint32_t, uint16_t>(577, 26));		// RJK2
}

void Initialize::routerId()
{
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(460600067, 186));		// Gandhinagar 		- 27.116.51.3
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(1728145153, 57));		// Junagadh 		- 103.1.103.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(460940545, 17));		// Nadiad 			- 27.121.101.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(175075073, 12));		// AHMEDABAD		- 10.111.111.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(175075075, 12));		// AHMEDABAD_BNG1	- 10.111.111.3
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(175075118, 12));		// AHMEDABAD_BNG2	- 10.111.111.46
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(460600321, 221));		// ANAND			- 27.116.52.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(2523654401, 151));	// ANKLESHWAR		- 150.107.233.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(2525049857, 248));	// BARDOLI			- 150.129.52.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(175075108, 5));		// BARODA			- 10.111.111.36
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(175075084, 5));		// BARODA_BNG1		- 10.111.111.12
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(175075324, 5));		// BARODA_BNG2		- 10.111.111.252
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(1897140991, 63));		// BHARUCH			- 113.20.18.255
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(1729470721, 124));	// BHAVNAGAR		- 103.21.161.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(1744479233, 218));	// BILLIMORA			- 103.250.164.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(1744477953, 128));	// HALOL			- 103.250.159.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(736100609, 258));		// JAIPUR			- 43.224.1.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(1729470465, 135));	// JAMNAGAR			- 103.21.160.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(2525065985, 389));	// KIM				- 150.129.115.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(460940803, 60));		// MEHSANA			- 27.121.102.3
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(2738212865, 74));		// MODASA			- 163.53.208.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(2525074689, 15));		// MORBI			- 150.129.149.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(1729471233, 95));		// NAVSARI			- 103.21.163.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(736100865, 271));		// PATNA			- 43.224.2.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(2641873921, 290));	// PUNE				- 157.119.204.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(175075083, 85));		// RAJKOT			- 10.111.111.11
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(175075118, 64));		// SURAT			- 10.111.111.46
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(175075085,64));		// SURAT_BNG1		- 10.111.111.13
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(175075325, 64));		// SURAT_BNG2		- 10.111.111.253
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(1743822849, 193));	// UNJHA			- 103.240.160.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(1741766913, 6));		// VAPI				- 103.209.65.1
	initSection::routerIdMap.insert(std::pair<uint32_t, uint16_t>(737263617, 8));		// VARANASI			- 43.241.192.1
}
...
//{
//	string filePath = IPGlobal::DATA_DIR[0] + "dnsIpv4data.csv";
//
//	std::string line;
//	std::string url;
//	uint32_t ip;
